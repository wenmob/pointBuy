...
export const API = {
  ...
  getRegister (mobile, username, password, smsCode, registerFrom, referrerType, referrerId, callBack) {
    let dataJson = {registerFrom: registerFrom, smsCode: smsCode, password: password, username: username, mobile: mobile, referrerType: referrerType, referrerId: referrerId}
    this.CommonApis(
      'post',
      '/register',
      dataJson,
  ...
  get_sms_code (mobile, action, validateCode, callBack) {
    let dataJson = {mobile: mobile, action: action, validateCode: validateCode}
    this.CommonApis(
      'post',
      '/get-sms-code',
      dataJson,
  ...
  getLogin (mobile, password, callBack) {
    let dataJson = {mobile: mobile, password: password}
    this.CommonApis(
      'post',
  ...
  // 忘记登录密码接口
  changeLoginPaw (type, mobile, password, smsCode, callBack) {
    let dataJson = {mobile: mobile, password: password, smsCode: smsCode}
    this.CommonApis(
      'post',
      '/resetPsw/save',
      dataJson,
  ...
  checkIdcard (name, idCardNo, callBack) {
    let dataJson = {idCardNo: idCardNo, name: name}
    this.CommonApis(
      'post',
      '/user/idcard/check',
      dataJson,
  ...
  saveUserBank (bankId, province, city, district, branch, number, callBack) {
    let dataJson = {bankId: bankId, province: province, city: city, district: district, branch: branch, number: number}
    this.CommonApis(
      'post',
      '/user/bank/save',
      dataJson,
  ...
  goAlipayBound (money, name, account, callBack) {
    let dataJson = {money: money, name: name, account: account}
    this.CommonApis(
      'post',
  ...
  updateLoginPsw (originalPwd, newPwd, callBack) {
    let dataJson = {originalPwd: originalPwd, newPwd: newPwd}
    this.CommonApis(
      'post',
  ...
  savePayPsw (payPassword, callBack) {
    let dataJson = {payPassword: payPassword}
    this.CommonApis(
      'post',
      '/user/setPayPsw/save',
      dataJson,
  ...
  baseMyusers (page, pageSize, callBack) {
    let dataJson = {page: page, pageSize: pageSize}
    this.CommonApis(
      'post',
      '/user/base/my-users',
      dataJson,
  ...
  getNotice (page, pageSize, type, callBack) {
    let dataJson = {page: page, pageSize: pageSize, type: type}
    this.CommonApis(
      'post',
      '/site/notice',
      dataJson,
  ...
  // 资金明细接口
  userMoneyCashLog (orderNumber, btype, page, pageSize, callBack) {
    let dataJson = {orderNumber: orderNumber, btype: btype, page: page, pageSize: pageSize}
    this.CommonApis(
      'post',
  ...
  trueNetBank (bankId, verifyCode, callBack) {
    let dataJson = {verifyCode: verifyCode}
    this.CommonApis(
      'post',
  ...
  userCashWithdrawApply (amount, payPwd, callBack) {
    let dataJson = {payPwd: payPwd, amount: amount}
    this.CommonApis(
      'post',
  ...
  historyTaddOne (dateAddBegin, dateAddEnd, page, pageSize, callBack) {
    let dataJson = {dateAddBegin: dateAddBegin, dateAddEnd: dateAddEnd, page: page, pageSize: pageSize}
    this.CommonApis(
      'post',
  ...
  historyTaddD (year, page, pageSize, callBack) {
    let dataJson = {year: year, page: page, pageSize: pageSize}
    this.CommonApis(
      'post',
  ...
  autoContinueFlag (strategyInfoId, continueFlag, callBack) {
    let dataJson = {strategyInfoId: strategyInfoId, continueFlag: continueFlag}
    this.CommonApis(
      'post',
  ...
  updateCloseLine (stockId, price, callBack) {
    let dataJson = {stockId: stockId, price: price}
    this.CommonApis(
      'post',
  ...
  addDeposit (strategyInfoId, deposit, lowClose, callBack) {
    let dataJson = {strategyInfoId: strategyInfoId, deposit: deposit, lowClose: lowClose}
    this.CommonApis(
      'post',
  ...
  continueStrategy (strategyInfoId, callBack) {
    let dataJson = {strategyInfoId: strategyInfoId}
    this.CommonApis(
      'post',
  ...
  addAmount (strategyId, amount, callBack) {
    let dataJson = {strategyId: strategyId, amount: amount}
    this.CommonApis(
      'post',
  ...
  createTAddD (data, callBack) {
    this.CommonApis(
      'post',
      '/user/strategyInfo/saveTAddD',
      data,
      callBack,
      true
    )
  },
  buyTAddD (data, callBack) {
    this.CommonApis(
      'post',
      '/user/strategyStock/buyStockTD',
      data,
      callBack,
      true
    )
